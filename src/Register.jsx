      ...
      <div className="register-section">
        <div className='register-block'>
            ...
            <div className='register-fields'>
                  <input type="text" className="register-login" placeholder='ИМЯ'/>
                  <input type="text" className="register-password" placeholder='ФАМИЛИЯ'/>
                  <input type="text" className="register-password" placeholder='ПОЧТА'/>
                  <input type="text" className="register-password" placeholder='НОМЕР ТЕЛЕФОНА'/>
                  <input type="text" className="register-password" placeholder='ПАРОЛЬ'/>
            </div>
            <div className="button-telegram">
              <a href="https://telegram.com" className="telegram-link">
              <a href='#' className="button-2">
                ...
                Войти через телеграмм
                </a>
            </div>
            <div className="buttons-low-reg">
            <a href='/auth' className="try-btn-reg" onClick={sendBtn}>Вход
              {/* <div class="sparkle-button">
                ...
                <a href='/profile' className="watch-video-reg" onClick={getBtn}>Регистрация
                    {/* <div class="sparkle-button">
